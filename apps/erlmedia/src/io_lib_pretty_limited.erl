...
print_term(Out, Bin, _Limit) when is_binary(Bin) orelse is_bitstring(Bin) ->
...
print_printable_list(Out, String, Limit) when Limit < 4 ->
  print_printable_list(Out, String, 4);
